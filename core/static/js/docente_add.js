function addInput() {
    ...
    if (inputValue.value == 1){
        p.innerText = "Añadiendo " + inputValue.value + " docente";
        pa.innerText = "Añadiendo " + inputValue.value + " docente";
    }
    else{
        p.innerText = "Añadiendo " + inputValue.value + " docentes";
        pa.innerText = "Añadiendo " + inputValue.value + " docentes";
    }
...
function deleteInput() {
    ...
    if (inputValue.value !=1 ){
        ...
        alert("No se pueden eliminar más docentes");
    }
